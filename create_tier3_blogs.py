...
# Output file
output_file = r"src\lib\data\blogs_part6.ts"

# Tier 3 Content Generator
# Goal: 2000+ words per blog. "Magnum Opus" standard.
# Structure: Hook -> History -> Deep Physics -> Analogy -> Table -> Materials -> Safety -> Future -> Q&A -> Summary.
...
export const BLOGS_PART_6: BlogPost[] = [
    {
        ...
        title: "The Invisible Army: How Magnets Work (Deep Dive)",
...
print(f"Created {output_file} with Tier 3 content.")
