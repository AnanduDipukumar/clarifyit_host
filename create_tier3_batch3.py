...
# Output file
output_file = r"src\lib\data\blogs_part8.ts"

# Tier 3 Content Generator - Batch 3 (Items 122-141)
# Topics: X-Ray, Anesthesia, Concrete, Gecko, Glow, Match, WaterTower, Siphon, Sewing, Balloon, Hydraulic, Inkjet, LaserPrint, Rocket, Lidar, Gear, Pen, Pulley, Firework, Crane.
...
print(f"Created {output_file} with Tier 3 content (Part 8 - First 5).")
